...
public static class TeamColorSwapper
{
            ...
            if (minimap != null)
            {
                ...
                if (map != null)
                {
                    ...
                    foreach (var kvp in map)
                    {
                        ...
                        if (profile != null && (core.QoLRunner.Instance?.Config?.localPlayerMinimapIconEnabled ?? false) && kvp.Key.Player.IsLocalPlayer)
                            continue;
    ...
    public static class MinimapStylePlayerPatch
    {
        ...
        public static void Postfix(UIMinimap __instance, PlayerBody playerBody)
        {
            try
            {
                ...
                if (profile != null && (core.QoLRunner.Instance?.Config?.localPlayerMinimapIconEnabled ?? false) && playerBody.Player.IsLocalPlayer)
                    return;
    ...
    public static class UIViewShowPatch
    {
        ...
        public static void Postfix(UIView __instance)
        {
            try
            {
                ...
                bool showCount = ToasterReskinLoader.core.QoLRunner.Instance?.Config?.enableTeamButtonPlayerCount ?? true;
    ...
    public static class UIChatParseChatContentPatch
    {
        ...
        {
            if (!(core.QoLRunner.Instance?.Config?.chatRenderAllEmojis ?? true)) return true;
