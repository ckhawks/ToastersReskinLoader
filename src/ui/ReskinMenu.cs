...
public static class ReskinMenu
{
    ...
    public static void CreateContentForSection(int sectionIndex)
    {
        ...
        switch (sections[sectionIndex])
        {
            ...
            case "Skybox":
                ...
                break;
            case "Goalie Equipment":
                CreateGoalieEquipmentSection(contentScrollViewContent);
                break;
            case "Goalie Helmets":
                CreateGoalieHelmetsSection(contentScrollViewContent);
                break;
            case "Full Arena":
    ...
    private static void CreateGoalieEquipmentSection(VisualElement container)
    {
        Plugin.LogDebug("Creating Goalie Equipment section");
        ...
        blueTeamLabel.style.fontSize = 20;
        blueTeamLabel.style.color = new Color(0.3f, 0.5f, 1f);
        blueTeamLabel.style.marginTop = 20;
        ...
        blueTeamRow.style.marginBottom = 30;
        

        VisualElement blueLeftContainer = new VisualElement();
        blueLeftContainer.style.flexGrow = 1;
        
        Label blueLeftLabel = new Label("Left Leg Pad");
        blueLeftLabel.style.fontSize = 14;
        blueLeftLabel.style.color = Color.white;
        blueLeftLabel.style.marginBottom = 5;
        blueLeftContainer.Add(blueLeftLabel);
        
        DropdownField blueLeftDropdown = new DropdownField();
        blueLeftDropdown.choices = legPadOptions;
        blueLeftDropdown.value = GetCurrentLegPadName("blue_left");
        blueLeftDropdown.RegisterValueChangedCallback(evt => OnLegPadSelected("blue_left", evt.newValue));
        blueLeftContainer.Add(blueLeftDropdown);
        

        VisualElement blueRightContainer = new VisualElement();
        blueRightContainer.style.flexGrow = 1;
        
        Label blueRightLabel = new Label("Right Leg Pad");
        blueRightLabel.style.fontSize = 14;
        blueRightLabel.style.color = Color.white;
        blueRightLabel.style.marginBottom = 5;
        blueRightContainer.Add(blueRightLabel);
        
        DropdownField blueRightDropdown = new DropdownField();
        blueRightDropdown.choices = legPadOptions;
        blueRightDropdown.value = GetCurrentLegPadName("blue_right");
        blueRightDropdown.RegisterValueChangedCallback(evt => OnLegPadSelected("blue_right", evt.newValue));
        blueRightContainer.Add(blueRightDropdown);
        
        blueTeamRow.Add(blueLeftContainer);
        blueTeamRow.Add(blueRightContainer);
        container.Add(blueTeamRow);
        

        Label redTeamLabel = new Label("RED TEAM");
        redTeamLabel.style.fontSize = 20;
        redTeamLabel.style.color = new Color(1f, 0.3f, 0.3f);
        redTeamLabel.style.marginTop = 10;
        ...
        VisualElement redLeftContainer = new VisualElement();
        redLeftContainer.style.flexGrow = 1;
        
        Label redLeftLabel = new Label("Left Leg Pad");
        redLeftLabel.style.fontSize = 14;
        redLeftLabel.style.color = Color.white;
        redLeftLabel.style.marginBottom = 5;
        redLeftContainer.Add(redLeftLabel);
        
        DropdownField redLeftDropdown = new DropdownField();
        redLeftDropdown.choices = legPadOptions;
        redLeftDropdown.value = GetCurrentLegPadName("red_left");
        redLeftDropdown.RegisterValueChangedCallback(evt => OnLegPadSelected("red_left", evt.newValue));
        redLeftContainer.Add(redLeftDropdown);
        

        VisualElement redRightContainer = new VisualElement();
        redRightContainer.style.flexGrow = 1;
        
        Label redRightLabel = new Label("Right Leg Pad");
        redRightLabel.style.fontSize = 14;
        redRightLabel.style.color = Color.white;
        redRightLabel.style.marginBottom = 5;
        redRightContainer.Add(redRightLabel);
        
        DropdownField redRightDropdown = new DropdownField();
        redRightDropdown.choices = legPadOptions;
        redRightDropdown.value = GetCurrentLegPadName("red_right");
        redRightDropdown.RegisterValueChangedCallback(evt => OnLegPadSelected("red_right", evt.newValue));
        redRightContainer.Add(redRightDropdown);
        
        redTeamRow.Add(redLeftContainer);
        redTeamRow.Add(redRightContainer);
        container.Add(redTeamRow);
    }
    
    private static void CreateGoalieHelmetsSection(VisualElement container)
    {
        Plugin.LogDebug("Creating Goalie Helmets section");
        ...
        Label description = new Label("Custom textures for goalie helmets (mask). Only for goalies.");
        ...
        columnsContainer.style.marginBottom = 30;
    

        VisualElement blueColumn = CreateTeamHelmetColumn("blue", "BLUE TEAM", new Color(0.3f, 0.5f, 1f));
        columnsContainer.Add(blueColumn);
    

        VisualElement redColumn = CreateTeamHelmetColumn("red", "RED TEAM", new Color(1f, 0.3f, 0.3f));
        columnsContainer.Add(redColumn);
    
        container.Add(columnsContainer);
    }

    private static VisualElement CreateTeamHelmetColumn(string team, string teamName, Color teamColor)
    {
